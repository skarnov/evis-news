...
<div class="container ">
	...
	<div class="col-md-8 col-xs-12 categoryPost catTitle">
		<h1 class="bold catTitle text-center">Search Results</h1>
	</div>
 ...
 ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            $query = "SELECT * FROM posts WHERE post_title LIKE '%$search%' OR post_tags LIKE '%$search%' OR post_content LIKE '%$search%'";
      ...
      <ul class="pager">
          ...
          for($i=1; $i<=$count; $i++) {
            ...
            if($i == $page) {
              echo "<li ><a class='active' href='search.php?search={$search}&page={$i}'>{$i}</a></li>";
            } else {
